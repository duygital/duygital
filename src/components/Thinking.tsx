...
export default function Thinking({ language, workflow }: ThinkingProps) {
  ...
  return (
    <section className="relative min-h-screen py-24 px-6 md:px-12 lg:px-24 max-w-5xl mx-auto z-20 font-sans" id="thinking-process-section">
      ...
      <div className="border-b border-paper/30 pb-8 mb-20">
        <span className="font-mono text-sm text-brand tracking-[0.2em] block mb-3 font-bold">
          {t.thinking.tag}
        </span>
        <h2 className="font-display text-4xl md:text-6xl font-semibold text-paper uppercase leading-tight">
          {t.thinking.title}
        </h2>
      </div>
      ...
      <div className="space-y-24 text-paper">
        ...
        <div className="border-b border-paper/20 pb-16">
          <div className="mb-12">
            <span className="font-mono text-xs text-brand tracking-[0.2em] block mb-2 font-bold">
              SECTION 01
            </span>
            <h3 className="font-display text-3xl md:text-4xl text-paper font-semibold uppercase tracking-tight">
              {language === "vi" ? "QUY TRÌNH PHỐI HỢP DỰNG HÌNH" : "CO-CREATIVE TIMELINE PROCESS"}
            </h3>
            <p className="text-xs font-mono text-brand/90 uppercase mt-1 tracking-wider">
              {language === "vi" 
          ...
          <div className="relative border-l-2 border-paper/20 pl-6 md:pl-10 ml-2 space-y-12">
            {activeSteps.map((step, idx) => {
              ...
              return (
                <div key={idx} className="relative group hover:transform hover:translate-x-1 transition-all duration-300">
                  {/* Visual marker dot */}
                  <div className={`absolute -left-[33px] md:-left-[49px] top-1.5 w-4 h-4 bg-bg border-2 ${isAccentStep ? 'border-brand' : 'border-paper/40'} rounded-full flex items-center justify-center`}>
                    {isAccentStep && <div className="w-2 h-2 bg-brand rounded-full" />}
                  </div>
                  ...
                  <h4 className="text-xl font-display text-paper font-semibold uppercase tracking-tight mb-2">
                    {step.title}
                  </h4>
                  
                  <p className="text-base text-paper/85 leading-relaxed font-sans mb-3 max-w-3xl">
                    {step.description}
                  </p>

                  <div className="flex flex-wrap gap-4 items-center mt-2.5">
                    {step.duration && (
                      <span className="font-mono text-[10px] text-brand/90 font-bold bg-brand/10 border border-brand/20 px-2.5 py-0.5 uppercase tracking-wider">
                        {language === "vi" ? `Thời lượng: ${step.duration}` : `Timeline: ${step.duration}`}
                      </span>
                    )}
                    {step.deliverable && (
                      <span className="font-mono text-[10px] text-paper/60 font-bold bg-paper/5 border border-paper/10 px-2.5 py-0.5 uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-20 text-left">
          ...
          <div className="border-t-2 border-paper/20 pt-8">
            <span className="font-mono text-xs text-brand tracking-[0.2em] block mb-2 font-bold uppercase">
              SECTION 02
            </span>
            <h4 className="font-display text-xl text-paper font-bold uppercase mb-4 tracking-tight">
              {language === "vi" ? "QUY ĐỊNH PHẢN HỒI (FEEDBACK)" : "FEEDBACK SWEEPS"}
            </h4>
            <div className="space-y-4 text-sm text-paper/90 font-medium leading-relaxed">
              <p>
                {language === "vi"
              ...
              <p className="font-bold text-paper border-l-2 border-brand pl-3">
          ...
          <div className="border-t-2 border-paper/20 pt-8">
            ...
            <div className="space-y-4 text-sm text-paper/90 font-medium leading-relaxed">
              ...
              <p className="font-bold border-l-2 border-brand pl-3">
          ...
          <div className="border-t-2 border-paper/20 pt-8">
            ...
            <div className="space-y-4 text-sm text-paper/90 font-medium leading-relaxed">
              ...
              <div className="bg-paper/[0.04] p-4 border border-paper/10 rounded-none">
                <span className="block font-mono text-xs text-brand font-bold uppercase mb-1">SHORT-FORM</span>
                <p>
                  {language === "vi"
              ...
              <div className="bg-paper/[0.04] p-4 border border-paper/10 rounded-none">
                <span className="block font-mono text-xs text-brand font-bold uppercase mb-1">LONG-FORM</span>
                <p>
                  {language === "vi"
          ...
          <div className="border-t-2 border-paper/20 pt-8">
            ...
            <div className="space-y-4 text-sm text-paper/90 font-medium leading-relaxed">
              ...
              <ul className="pl-5 list-disc space-y-2 text-brand font-semibold">
        ...
        <div className="border-t-2 border-paper/20 pt-16">
          <div className="mb-10">
            <span className="font-mono text-xs text-brand tracking-[0.2em] block mb-2 font-bold">
              SECTION 08
            </span>
            <h3 className="font-display text-2xl md:text-3xl text-paper font-semibold uppercase tracking-tight">
              {language === "vi" ? "QUY ĐỊNH BẢN QUYỀN VÀ TÀI NGUYÊN" : "INTELLECTUAL PROPERTY & ASSETS"}
            </h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 font-sans text-sm text-paper/95 font-medium leading-relaxed">
            <div className="space-y-4">
              <p className="font-bold text-paper uppercase">
                {language === "vi" ? "Tài nguyên Khách hàng bảo đảm:" : "Client Provided Assets:"}
              </p>
              <ul className="pl-5 list-disc space-y-2 text-paper">
              ...
              <p className="mt-4 text-paper/80 font-normal">
                {language === "vi"
            ...
            <div className="space-y-4">
              ...
              <p className="italic text-brand font-bold text-sm bg-brand/10 p-3 border-l-2 border-brand">
                {language === "vi"
      ...
      <div className="mt-28 border border-paper/30 bg-paper/[0.04] p-8 md:p-12 rounded relative overflow-hidden text-left shadow-[0_8px_30px_rgb(0,0,0,0.5)]">
        <CornerRightDown className="absolute -bottom-6 -right-6 w-24 h-24 text-paper/10 stroke-[0.5] pointer-events-none" />
        <span className="font-mono text-xs text-brand tracking-[0.2em] block mb-3 font-bold uppercase animate-pulse">
          {language === "en" ? "STATEMENT OF INTENT" : "CAM KẾT CHẤT LƯỢNG"}
        </span>
        <p className="font-serif italic text-xl md:text-3xl text-paper leading-relaxed max-w-3xl font-medium">
